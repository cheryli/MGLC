!!! WARNING: This code can only be Running with -O0

!!!    This program simulates "Two circular particles settling in a vertical channel"
!!!    Copyright (C) 2017  Ao Xu
...
!!!    Ao Xu, Profiles: <http://www.linkedin.com/pub/ao-xu/30/a72/a29>
    ...
    module commondata
        ...
        real(8), parameter :: thresholdWall=2.0d0
        real(8), parameter :: stiffWall=0.25d0
        
        real(8), parameter :: thresholdParticle=2.0d0
